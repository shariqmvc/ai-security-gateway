...
import com.ai.gateway.core.routing.intelligence.RoutingDecisionContext;
import com.ai.gateway.core.routing.intelligence.RoutingDecisionExplanation;
import com.ai.gateway.core.routing.intelligence.RoutingDecisionIntelligence;
import com.ai.gateway.core.routing.intelligence.NoopRoutingDecisionIntelligence;
import com.ai.gateway.core.routing.health.FailureAwareCandidateFilter;
import com.ai.gateway.core.routing.selection.CandidateSelectionEngine;
import com.ai.gateway.core.routing.selection.RoutingSelectionMode;
...
import com.ai.gateway.core.routing.selection.CandidateSelectionExplanation;
import com.ai.gateway.core.cost.routing.CostAwareCandidate;
import com.ai.gateway.core.cost.routing.CostAwareRoutingEvaluator;
...
import com.ai.gateway.core.routing.scoring.objective.profile.RoutingOptimizationProfileResolver;
...
public class PolicyBasedRoutingStrategy
    ...
    public PolicyBasedRoutingStrategy(
        ...
        this(
                ...
                new FailureAwareCandidateFilter(new com.ai.gateway.core.routing.health.RoutingHealthService() {
                    public com.ai.gateway.core.routing.health.RoutingHealthSnapshot snapshot(com.ai.gateway.core.routing.engine.RoutingCandidate c) { return null; }
                    public java.util.List<com.ai.gateway.core.routing.health.RoutingHealthSnapshot> snapshots() { return java.util.List.of(); }
                    public void recordSuccess(com.ai.gateway.core.routing.engine.RoutingCandidate c, long l) {}
                    public void recordFailure(com.ai.gateway.core.routing.engine.RoutingCandidate c, String f) {}
                    public boolean isHealthyForRouting(com.ai.gateway.core.routing.engine.RoutingCandidate c) { return true; }
                }),
                new CostAwareRoutingEvaluator(
                        new com.ai.gateway.core.cost.service.impl.PreRequestCostEstimatorImpl(
                                new com.ai.gateway.core.cost.pricing.CachedPricingCatalog(
                                        new com.ai.gateway.core.cost.config.PricingConfig())),
                        new com.ai.gateway.core.cost.routing.DefaultCostGuardrail())
        );
    }
    ...
    public PolicyBasedRoutingStrategy(
        ...
        this(
                ...
                new com.ai.gateway.core.routing.selection.impl.CandidateSelectionEngineImpl(),
                new NoopRoutingDecisionIntelligence(),
                new FailureAwareCandidateFilter(new com.ai.gateway.core.routing.health.RoutingHealthService() {
                    public com.ai.gateway.core.routing.health.RoutingHealthSnapshot snapshot(com.ai.gateway.core.routing.engine.RoutingCandidate c) { return null; }
                    public java.util.List<com.ai.gateway.core.routing.health.RoutingHealthSnapshot> snapshots() { return java.util.List.of(); }
    ...
    public RoutingDecision route(
         ...
         */
        com.ai.gateway.core.cost.routing.RoutingCostContext costContext =
    ...
    private RoutingSelectionRequest selectionRequest(com.ai.gateway.core.contract.ChatRequest request) {
