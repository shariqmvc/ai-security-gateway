-- AIRouter Personal: account-scoped request history and usage telemetry.
-- No tenant_id is stored; Personal data remains isolated from Business schemas.
CREATE TABLE PERSONAL_REQUEST_HISTORY (
    ...
    CONSTRAINT pk_personal_request_history PRIMARY KEY (id),
    CONSTRAINT uk_personal_request_history_request UNIQUE (request_id),
